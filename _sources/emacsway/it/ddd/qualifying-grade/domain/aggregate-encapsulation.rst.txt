...
Формирование в подобном стиле иерархической структуры с коллекциями объектов превращается в довольно ресурсосжигающую задачу.
Массовым такой подход вряд ли станет.
...
Использование такого подхода в тестовых кейсах делает их достаточно многословными - то, что можно выразить одной строкой, приходится выражать несколькими строками.
...
Но код первого варианта выглядит достаточно устрашающе, и трудоемкость его поддержания неоправданно высока.
