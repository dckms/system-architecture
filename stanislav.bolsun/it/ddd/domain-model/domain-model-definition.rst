...
Если контекста применимости нет или он неизвестен (что нас нужно решить), то у нас есть два возможных пути:
1. модель не создавать вообще
2. создать модель на все случаи жизни, но тогда придется полностью воспроизвести объект моделирования, что не позволит эффективно решать задачи (пример с навигацией кораблей по точной копии Земли).
