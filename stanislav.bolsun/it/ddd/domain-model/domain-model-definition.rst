...
В качестве иллюстрации сложности модели на все случаи жизни, рассмотрим примеры из доклада Эрика Эванса (Eric Evans — Tackling Complexity in the Heart of Software,
