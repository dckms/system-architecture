...
Этот контекст применимости выражен термином ограниченный контекст в DDD, который является границей применимости модели.

.. figure:: _media/model_of_earth_processes.png
   :alt: Model of Earth processes
   :align: center
   :width: 100%
На изображении выше, мы видим модель процессов Земли, служащую для решения необходимых задач.
