...
В качестве меры спасения можно использовать функции-конструкции, возвращающие указатель, иначе формирование в подобном стиле иерархической структуры с вложенными коллекциями структур превращается в довольно ресурсосжигающую задачу.
