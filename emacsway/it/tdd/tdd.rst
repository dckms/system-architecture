...
Но суть в том, что во время кодирования, ввод символов с клавиатуры занимает, в лучшем случае, 9% времени.
А 91% времени занимает обдумывание.
...
При TDD вы :ref:`больше работаете пальцами, но меньше работаете головой <emacsway-why-is-tdd-faster>`.
А поскольку 91% при кодировании занимает именно обдумывание, отсюда и бОльшее влияние на темпы разработки.
...
.. seealso::
   ...
   - ":ref:`emacsway-why-is-tdd-faster`"
