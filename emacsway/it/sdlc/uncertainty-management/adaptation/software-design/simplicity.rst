...
Они не понимают :ref:`The Primary Technical Imperative <emacsway-primary-technical-imperative>`.

Overengineering означает решение не соответствующее контексту, т.е. когда :ref:`уровень привнесенной сложности превышает уровень управляемой сложности <emacsway-agile-patterns>`.
...
Хороший архитектор стремится исключить само возникновение сложной проблемы, нежели пытается героически ее решить.
...
Давайте послушем другого известного "мастера простых решений", известного оружейного конструктора, создавшего наиболее надежный и простой автомат в истории:
...
Но ведь ключевой целью принципа `Low Coupling & High Cohesion <http://wiki.c2.com/?CouplingAndCohesion>`__ является управление сложностью, т.е. упрощение, а не усложнение!
...
Лаконичность кода определяется уровнем его сложности на горизонте его рассмотрения (на уровне абстракции), а не количеством символов.
