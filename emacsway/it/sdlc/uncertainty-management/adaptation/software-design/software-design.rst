...
Допустим, что разработчику нужно написать вдвое больше кода без роста когнитивной нагрузки.
Т.е. вместо соотношения 1:10 (где 1 - это время ввода символов с клавиатуры, а 10 - время чтение кода и борьбу со сложностью) получится соотношение 2:10, что равно 17%:83% вместо 9%:91%.
...
Т.е. вместо соотношения 1:10 (где 1 - это время ввода символов с клавиатуры, а 10 - время чтение кода и борьбу со сложностью) получится соотношение 1:5, что равно 17%:83% вместо 9%:91%.
...
Конечно, коэффициенты сильно завышены, но они хорошо раскрывают механизм ускорения темпов разработки с использованием TDD.
На практике TDD дает прирост разработки около 10% (см. главу "Chapter 1. What Is Design and Architecture? :: What went wrong?" книги "Clean Architecture: A Craftsman's Guide to Software Structure and Design" by Robert C. Martin).
