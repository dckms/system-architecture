...
По поводу последнего изречения - лучше один раз увидеть на примере метафоры со схожим эффектом:
...
Если количество объектов рассмотрения превышает возможности организма человека, то он не может рассмотреть их одновременно, в прямом и в переносном смыслах.
Как и в "Законе Миллера", все сводится к тому, что объем поступающей информации превышает способность организма её **воспринимать**.
