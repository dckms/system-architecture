...
Именно эту ошибку я нередко наблюдал у малоопытных разработчиков, и, увы, когда падение внутреннего качества программы начинало вызывать проблемы со сроками, то аргументы типа "вы же сами так решили" или "вас же предупреждали" не помогали им переложить вину на Product Owner.
...
Другое проявление этой ловушки - все думают, что ":ref:`потом исправим <emacsway-agile-common-planning-errors>`".
Однако, лучший момент для исправления, если смотреть сугубо с математической точки зрения, - это именно сейчас, пока величина технического долга наименьшая.
Чем больше накапливается технический долг, тем меньше остается ресурсов для исправления и тем :ref:`дороже становится исправление <emacsway-compound-interest>`.
Потом будет более невыгодное положение, чем сейчас.
