...
Именно эту ошибку я нередко наблюдал у малоопытных разработчиков, и, увы, когда падение внутреннего качества программы начинало вызывать проблемы со сроками, то аргументы типа "вы же сами так решили" или "вас же предупреждали" не помогали им переложить вину на представителя бизнеса.
